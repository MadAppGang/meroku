...
export function ServiceXRayConfiguration({ config, onConfigChange, node }: ServiceXRayConfigurationProps) {
      ...
      <CardContent className="space-y-4">
        <div className="flex items-center justify-between">
          ...
          <Switch
            ...
            onCheckedChange={(checked) => handleServiceChange({ xray_enabled: checked })}
        ...
        {serviceConfig.xray_enabled && (
          <Alert>
            ...
            <AlertDescription>
              X-Ray tracing is enabled. Your service will send trace data to AWS X-Ray.
              Make sure your application is instrumented with the X-Ray SDK.
            </AlertDescription>
          </Alert>
        )}
      </CardContent>
