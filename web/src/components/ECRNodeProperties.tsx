						...
						<div className="mt-4 space-y-3">
							<div className="bg-blue-900/20 border border-blue-700 rounded-lg p-3">
								<div className="flex items-start gap-2">
									...
									<div className="space-y-1">
										...
										<div className="text-xs text-gray-400">
											Note: Repositories are only created in the{" "}
											<code className="text-blue-400">dev</code> environment
										</div>
									</div>
								</div>
							</div>
							...
							<div className="bg-yellow-900/20 border border-yellow-700 rounded-lg p-3">
								...
								<ul className="text-xs text-gray-300 space-y-1">
									<li>
										• Repositories are created only in{" "}
										<code className="text-yellow-400">dev</code> environment
									</li>
									<li>
							...
							{config.ecr_account_id && (
								<div className="bg-yellow-900/20 border border-yellow-700 rounded-lg p-3">
									...
									<p className="text-xs text-gray-300 mb-2">
										The cross-account ECR repository must have a policy that
										allows this account to pull images:
									</p>
