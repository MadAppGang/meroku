...
export function AmplifyBuildSettings({
	config,
	nodeId,
	selectedBranch,
}: AmplifyBuildSettingsProps) {
		...
		<div className="space-y-6">
				...
				<div className="bg-gray-800 rounded-lg p-4 border border-gray-700 space-y-3">
					<div className="flex items-start gap-2">
						...
						<div className="text-sm text-gray-300 space-y-2">
							<p className="font-medium">
								Amplify automatically detects your framework and build settings:
							</p>
							<ul className="list-disc list-inside space-y-1 text-xs text-gray-400 ml-2">
								<li>
									Scans for framework files (package.json, next.config.js, etc.)
								</li>
								<li>
					...
					<div className="border-t border-gray-700 pt-3">
						<p className="text-xs text-gray-400">
							<span className="font-medium">Detected frameworks include:</span>{" "}
							React, Vue, Angular, Next.js, Nuxt.js, Gatsby, Svelte/SvelteKit,
							Astro, Ember, and more.
						</p>
					</div>
				</div>
			</div>
			...
			<div>
				...
				<div className="bg-gray-800 rounded-lg p-4 border border-gray-700">
					<p className="text-sm text-gray-300 mb-3">
						For custom build requirements, create an{" "}
						<code className="bg-gray-900 px-1 py-0.5 rounded text-blue-400">
							amplify.yml
						</code>{" "}
					...
					<Tabs defaultValue="react" className="mt-4">
						<TabsList className="grid grid-cols-4 w-full bg-gray-900">
							...
							<TabsTrigger value="monorepo" className="text-xs">
								Monorepo
							</TabsTrigger>
						...
						<TabsContent value="react" className="mt-4">
							<div className="space-y-2">
								<div className="flex items-center justify-between">
									<p className="text-xs text-gray-400">
										Standard React/Vue build configuration
									</p>
									<Button
										size="sm"
										variant="ghost"
										onClick={() =>
											copyToClipboard(amplifyYmlExamples.react, "react")
										}
									>
										{copiedExample === "react" ? (
											<>
						...
						<TabsContent value="nextjs" className="mt-4">
							<div className="space-y-2">
								<div className="flex items-center justify-between">
									<p className="text-xs text-gray-400">
										Next.js/Nuxt.js configuration
									</p>
									<Button
										size="sm"
										variant="ghost"
										onClick={() =>
											copyToClipboard(amplifyYmlExamples.nextjs, "nextjs")
										}
									>
							...
							<div className="space-y-2">
								<div className="flex items-center justify-between">
									...
									<Button
										...
										variant="ghost"
										onClick={() =>
											copyToClipboard(amplifyYmlExamples.monorepo, "monorepo")
										}
									>
							...
							<div className="space-y-2">
								<div className="flex items-center justify-between">
									...
									<Button
										...
										variant="ghost"
										onClick={() =>
											copyToClipboard(amplifyYmlExamples.custom, "custom")
										}
									>
			...
			<div>
				...
				<div className="bg-gray-800 rounded-lg p-4 border border-gray-700 space-y-3">
					...
					<div className="border-t border-gray-700 pt-3">
						<p className="text-xs text-gray-400">
							<span className="font-medium">Available tools:</span> AWS CLI,
							Git, cURL, Python, Ruby, and more pre-installed in the build
							environment.
						</p>
					</div>
				</div>
