...
import { X, ArrowUp, ArrowRight, ArrowDown, ArrowLeft, LogIn, LogOut } from 'lucide-react';
...
export function EdgeHandleSelector({ edge, position, onClose, onHandleChange }: EdgeHandleSelectorProps) {
  const [sourceHandle, setSourceHandle] = useState(edge.sourceHandle || 'source-right');
  const [targetHandle, setTargetHandle] = useState(edge.targetHandle || 'target-left');
