			...
			view("setup", "Setup", [
				section(
					...
					[
						...
						{
							id: "aurora-min-capacity",
							label: "Minimum capacity",
							kind: "number",
							value: 0,
							unit: "ACU",
							span: "half",
							description: "Zero pauses the cluster when idle",
						},
						{
							id: "aurora-max-capacity",
					...
					[
						{
							...
							kind: "readonly",
							value:
								"circl-dev.cluster-example.ap-southeast-2.rds.amazonaws.com",
							mono: true,
						},
						{
							id: "aurora-port",
				...
				section(
					...
					[
						...
						},
						{
							...
							label: "Edge handles",
							kind: "tags",
							value: ["source: right", "target: left"],
						},
					],
					{ icon: Boxes, iconTone: "info" },
				),
			]),
		],
	},
	dynamicGroup: {
		nodeType: "dynamicGroup",
		name: "Additional services",
		displayName: "Dynamic canvas group",
		icon: Layers3,
		status: "Layout",
		statusTone: "neutral",
		context: "Canvas only · generated membership",
		views: [
			view("layout", "Layout", [
				section(
					...
					[
						...
						{
							id: "dynamic-group-handles",
							label: "Generated edge handles",
							kind: "tags",
							value: ["service → alb", "service → database"],
						},
					],
					{ icon: Layers3, iconTone: "info" },
				),
