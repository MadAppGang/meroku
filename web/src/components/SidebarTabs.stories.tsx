...
export const SettingsTab: Story = {
	...
	parameters: {
		docs: {
			description: {
				story:
					"Settings tab showing service configuration, status, and deployment options",
			},
		},
	},
};
...
export const LogsTab: Story = {
	...
	play: async ({ canvasElement }) => {
		...
		const logsButton = canvasElement.querySelector(
			"button:has(.lucide-file-text)",
		);
		if (logsButton) {
	...
	parameters: {
		docs: {
			description: {
				story:
					"Logs tab displaying recent application logs with different severity levels",
			},
		},
	},
};
...
export const MetricsTab: Story = {
	...
	play: async ({ canvasElement }) => {
		...
		const metricsButton = canvasElement.querySelector(
			"button:has(.lucide-bar-chart-3)",
		);
		if (metricsButton) {
	...
	parameters: {
		docs: {
			description: {
				story:
					"Metrics tab showing performance metrics like CPU, Memory, Requests/min, and Uptime",
			},
		},
	},
};
...
export const EnvironmentTab: Story = {
	...
	parameters: {
		docs: {
			description: {
				story:
					"Environment variables tab for managing service configuration values",
			},
		},
	},
};
...
export const ConnectionsTab: Story = {
	...
	play: async ({ canvasElement }) => {
		...
		const connectionsButton = canvasElement.querySelector(
			"button:has(.lucide-link)",
		);
	...
	parameters: {
		docs: {
			description: {
				story:
					"Connections tab showing which other services this service is connected to",
			},
		},
	},
};
