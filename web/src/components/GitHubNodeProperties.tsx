...
export function GitHubNodeProperties({ config, onConfigChange }: GitHubNodePropertiesProps) {
  ...
  const handleToggleOIDC = (checked: boolean) => {
    onConfigChange({
      workload: {
        ...
        github_oidc_subjects: checked && subjects.length === 0 
          ...
          {isEnabled && (
            <div className="space-y-4 pt-4 border-t border-gray-700">
              ...
              <div className="rounded-lg bg-gray-800 p-3">
                <h4 className="text-sm font-medium text-gray-300 mb-2">Subject Format Examples:</h4>
                <ul className="space-y-1 text-xs text-gray-400">
                  <li>• <code className="text-blue-400">repo:Owner/Repo:ref:refs/heads/main</code> - Main branch only</li>
                  <li>• <code className="text-blue-400">repo:Owner/Repo:ref:refs/heads/*</code> - All branches</li>
                  <li>• <code className="text-blue-400">repo:Owner/Repo:ref:refs/tags/*</code> - All tags</li>
                  <li>• <code className="text-blue-400">repo:Owner/Repo:environment:production</code> - Specific environment</li>
                </ul>
              </div>
            </div>
          )}
