...
import { Github, ExternalLink, Check, Loader2, AlertCircle, Copy } from 'lucide-react';
...
export function AmplifyNodeProperties({ config, nodeId, onConfigChange }: AmplifyNodePropertiesProps) {
  ...
  return (
    <div className="space-y-6">
      ...
      <div>
        <h3 className="text-sm font-medium text-white mb-4">General Information</h3>
        <div className="space-y-3">
          <div>
            ...
            <Input
              ...
              disabled
            />
            <p className="text-xs text-gray-500 mt-1">App name cannot be changed after creation</p>
          </div>
          ...
          <div>
            ...
            <Input
              ...
              onChange={(e) => handleChange('github_repository', e.target.value)}
            ...
            <div className="flex items-center justify-between">
              <div>
                ...
                <p className="text-xs text-gray-400 mt-1">
                  {amplifyApp.branches?.length || 0} branch{(amplifyApp.branches?.length || 0) !== 1 ? 'es' : ''} configured
                </p>
              </div>
          ...
          {checkingToken ? (
              ...
              <>
                <div className="space-y-4">
                  <div className="text-center space-y-2">
                    ...
                    <p className="text-xs text-gray-500">
                      Code copied to clipboard! A popup window should have opened with GitHub.
                    </p>
                  </div>
              ...
              <div className="space-y-2">
                ...
                <p className="text-xs text-gray-600">
                  Token stored in SSM: <code className="bg-gray-900 text-gray-300 px-1 rounded">{getSsmParameterPath()}</code>
                </p>
      ...
      <div>
        <h3 className="text-sm font-medium text-white mb-4">Management Console</h3>
        <a
          href={consoleUrl}
          target="_blank"
