...
const ChartStyle = ({ id, config }: { id: string; config: ChartConfig }) => {
	...
	return (
		<style
			// biome-ignore lint/security/noDangerouslySetInnerHtml: upstream shadcn/ui pattern; emits CSS custom properties from a developer-authored ChartConfig, never user input, so there is no injection path.
