...
This email confirms that your SES configuration is working correctly.`);
	...
	const handleSendEmail = async () => {
		...
		try {
			const result = await infrastructureApi.sendTestEmail(
				config.env || "dev",
				to,
				subject,
				body,
	...
	return (
		<div className="space-y-4">
			...
			<Alert>
				...
				<AlertDescription>
					Test emails will be sent from{" "}
					<code className="text-blue-400">{fromAddress}</code>
			...
			<Card>
				...
				<CardContent className="space-y-4">
					...
					{response && (
						<Alert
							className={
								response.success ? "border-green-600" : "border-red-600"
							}
						>
							{response.success ? (
			...
			<Card>
				...
				<CardContent>
					<div className="bg-gray-900 rounded-lg p-3 font-mono text-xs text-gray-300 space-y-1">
						...
						<div>
							<span className="text-gray-500">X-SES-Configuration-Set:</span>{" "}
