      ...
      <DialogContent className="max-w-2xl">
        ...
        <div className="space-y-4">
          <Alert>
            ...
            <AlertDescription>
              Build logs are available in the AWS Amplify Console. Click the button below to view detailed logs,
              build artifacts, and deployment information.
            </AlertDescription>
          </Alert>
          ...
          <div className="bg-muted/50 rounded-lg p-4 text-sm text-muted-foreground">
            <p className="mb-2">
              <strong>Note:</strong> Real-time build logs streaming is available directly in the AWS Console.
            </p>
            <p>
              The AWS Amplify Console provides:
            </p>
