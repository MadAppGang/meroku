      ...
      <div className="flex items-center gap-6">
        {activeEnvironmentProfile && (
          <div className="flex items-center gap-2 hover:text-gray-200 transition-colors">
            ...
            <span className="text-gray-300" title={activeEnvironmentProfile}>{activeEnvironmentProfile}</span>
          </div>
        )}
        ...
        {rates && (
          <TooltipProvider>
            <Tooltip>
              ...
              <TooltipContent side="top" className="bg-gray-800 border-gray-700 text-gray-300 text-xs text-center">
                Pricing as of{" "}
                {new Date(rates.pricingDate || "2025-01-15").toLocaleDateString()}
                <br />
                Source: {rates.source === "aws_api" ? "AWS API" : "curated pricing"}
              </TooltipContent>
            </Tooltip>
          </TooltipProvider>
        )}
