						...
						<div className="flex items-start gap-2">
							...
							<div className="flex-1">
								...
								<p className="text-xs text-gray-300">
									This infrastructure uses <strong>RDS PostgreSQL</strong>{" "}
									instead of Aurora. RDS PostgreSQL provides a managed
									PostgreSQL database with automated backups, high availability,
									and read replicas support.
								</p>
								<p className="text-xs text-gray-400 mt-2">
									To configure the database, look for the PostgreSQL node in the
