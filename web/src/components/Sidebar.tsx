	...
	return (
		<div className="fixed right-0 top-0 h-full w-[768px] bg-gray-900 border-l border-gray-700 shadow-xl z-50 flex flex-col">
			...
			<div className="relative flex-shrink-0 border-b border-gray-700">
				...
				>
					<ChevronLeft
						className={`w-5 h-5 ${showLeftScroll ? "text-blue-400" : "text-gray-600"}`}
					/>
				</button>
				...
				>
					<ChevronRight
						className={`w-5 h-5 ${showRightScroll ? "text-blue-400" : "text-gray-600"}`}
					/>
				</button>
							...
							<>
								<div className="bg-green-900/20 border border-green-700 rounded-lg p-3">
									...
									<ul className="text-xs text-gray-400 space-y-1">
										...
										<li>
											• <code className="text-green-300">EventBridge</code>:
											Default event bus
										</li>
									</ul>
								</div>
								...
								<div className="bg-purple-900/20 border border-purple-700 rounded-lg p-3">
									...
									<ul className="text-xs text-gray-400 space-y-1">
										<li>
											• <code className="text-purple-300">ECR Strategy</code>:
											Cross-Account
										</li>
										<li>
								...
								<div className="bg-gray-800 rounded-lg p-3">
									...
									<ul className="text-xs text-gray-400 space-y-1">
										...
										<li>
											• Deployment is triggered manually or via EventBridge
											events
										</li>
										<li>
											• Ensure cross-account ECR trust policies are deployed in
											source account
										</li>
									</ul>
								</div>
							...
							<>
								...
								<div className="bg-blue-900/20 border border-blue-700 rounded-lg p-3">
									...
									<ul className="text-xs text-gray-400 space-y-1">
										...
										<li>
											✓{" "}
											<span className="text-blue-300">
												Auto-create ECR repo
											</span>{" "}
											- Creates repository if it doesn't exist
										</li>
										<li>
											✓ <span className="text-blue-300">Dual tagging</span> -
											Tags with both :latest and :sha for rollback
										</li>
										<li>
											✓{" "}
											<span className="text-blue-300">
								...
								<div className="bg-gray-800 rounded-lg p-3">
									...
									<ul className="text-xs text-gray-400 space-y-1">
										...
										<li>
											• The workflow will cancel any in-progress deployments
											when a new push occurs
										</li>
										<li>
											• Service stability check will fail the workflow if
											deployment fails
										</li>
									</ul>
								</div>
    ...
    "Condition": {
      ...
      "StringLike": {
        "token.actions.githubusercontent.com:sub": "repo:Owner/Repo:*"
				...
				{activeTab === "cicd" && selectedNode.type === "backend" && config && (
				...
				{activeTab === "cicd" && selectedNode.type === "service" && config && (
					<ServiceCICDConfiguration
						config={config}
						serviceName={selectedNode.id.replace("service-", "")}
						serviceType="service"
				...
				{activeTab === "cicd" && selectedNode.type === "amplify" && config && (
					<ServiceCICDConfiguration
						config={config}
