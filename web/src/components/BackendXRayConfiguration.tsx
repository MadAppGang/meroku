...
export function BackendXRayConfiguration({ config, onConfigChange }: BackendXRayConfigurationProps) {
    ...
    <div className="space-y-6">
      ...
      <Card>
        ...
        <CardContent className="space-y-4">
          ...
          <div className={`p-4 rounded-lg ${xrayEnabled ? 'bg-green-900/20 border border-green-700' : 'bg-gray-800'}`}>
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="grid grid-cols-1 gap-4">
                <div>
                  <label className="text-xs text-gray-400">Container Name</label>
                  <p className="text-sm font-mono text-gray-300">adot-collector</p>
                </div>
                ...
                <div>
                  ...
                  <p className="text-sm font-mono text-gray-300">{logGroupName}</p>
                </div>
              </div>
            </CardContent>
          </Card>
              ...
              <div className="space-y-3">
                ...
                <div className="space-y-2">
                  ...
                  <div className="grid grid-cols-3 gap-4 p-2 bg-gray-800 rounded text-xs">
                    ...
                    <p className="text-gray-300">TCP</p>
                    <p className="text-gray-300">Legacy Jaeger/Zipkin endpoint</p>
                  </div>
                </div>
              </div>
                ...
                <div className="flex items-start gap-2">
                  ...
                  <div className="flex-1">
                    <p className="text-xs text-gray-300">
                      The sidecar runs in the same network namespace as your backend container (awsvpc mode). 
          ...
          <Card>
            ...
            <CardContent>
              ...
              <div className="mt-4 p-3 bg-green-900/20 border border-green-700 rounded-lg">
                <p className="text-xs text-gray-300">
                  The ADOT collector sidecar runs efficiently alongside your backend container with minimal resource overhead.
                </p>
              </div>
            </CardContent>
          </Card>
            ...
            <CardContent>
              <ol className="space-y-3 text-xs text-gray-300">
                <li className="flex items-start gap-2">
                  ...
                  <span>ADOT collector sidecar is added to your ECS task definition</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-blue-400 font-medium flex-shrink-0">2.</span>
                  <span>The sidecar listens on <code className="text-blue-300">localhost:2000</code> for X-Ray traces</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-blue-400 font-medium flex-shrink-0">3.</span>
                  <span>Your backend application sends traces to <code className="text-blue-300">localhost:2000</code></span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-blue-400 font-medium flex-shrink-0">4.</span>
                  <span>ADOT collector forwards traces to AWS X-Ray service</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-blue-400 font-medium flex-shrink-0">5.</span>
                  <span>View traces in the AWS X-Ray console for debugging and performance analysis</span>
                </li>
              </ol>
              ...
              <div className="mt-4 p-3 bg-blue-900/20 border border-blue-700 rounded-lg">
                <div className="flex items-start gap-2">
                  ...
                  <div className="flex-1">
                    <h4 className="text-sm font-medium text-blue-400 mb-1">Environment Variable</h4>
                    <p className="text-xs text-gray-300">
                      The <code className="text-blue-300">ADOT_COLLECTOR_URL=localhost:2000</code> environment variable 
                      is automatically added to your backend container when X-Ray is enabled.
                    </p>
                  </div>
                </div>
              </div>
            ...
            <CardContent>
              <div className="space-y-4">
                <div className="p-3 bg-gray-800 rounded-lg">
                  <h4 className="text-sm font-medium text-gray-300 mb-2">Node.js Example</h4>
...
// via ADOT_COLLECTOR_URL env variable`}</pre>
                </div>
                
                <div className="p-3 bg-gray-800 rounded-lg">
                  <h4 className="text-sm font-medium text-gray-300 mb-2">Python Example</h4>
                  <pre className="text-xs text-gray-400 overflow-x-auto">
...
# AWS_XRAY_DAEMON_ADDRESS=localhost:2000`}</pre>
                </div>
                
                <div className="p-3 bg-gray-800 rounded-lg">
                  <h4 className="text-sm font-medium text-gray-300 mb-2">Java Example</h4>
                  <pre className="text-xs text-gray-400 overflow-x-auto">
{`// Add to your application
@EnableXRay

// The SDK will automatically use
// localhost:2000 as the daemon endpoint`}</pre>
                </div>
              </div>
            </CardContent>
          </Card>
            ...
            <div className="space-y-4">
              ...
              <div className="bg-blue-900/20 border border-blue-700 rounded-lg p-4">
                <div className="flex items-start gap-2">
                  <Info className="w-4 h-4 text-blue-400 mt-0.5" />
                  <div className="flex-1">
                    <h4 className="text-sm font-medium text-blue-400 mb-1">No Additional Resource Cost</h4>
                    <p className="text-xs text-gray-300">
                      X-Ray tracing runs efficiently within your existing container resources. 
                      The ADOT collector sidecar has minimal overhead.
                    </p>
                  </div>
                </div>
              </div>
